...
//             scroll_rows: 0,
//             scroll_cols: 0,
//             row_getter: Box::new(|_| None),
//             col_getter: Box::new(|_| None),
...
//     fn row<F>(&mut self, row: F) -> &Self 
//     where F: Fn(usize) -> Option<Row> + 'static
//     {
//         self.row_getter = Box::new(row);
//         return self;
//     }

//     fn col<F>(&mut self, col: F) -> &Self
//     where F: Fn(usize) -> Option<Col> + 'static
//     {
//         self.col_getter = Box::new(col);
//         return self;
//     }

//     fn cell<F>(&mut self, cell_getter: F) -> &Self 
//     where F: Fn(usize, usize) -> Option<Cell> + 'static
//     {
//         self.cell_getter = Box::new(cell_getter);
//         return self;
//     }
